      ...
      <div className="mx-auto grid justify-center gap-4 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3">
        <div className="relative overflow-hidden rounded-lg border bg-background p-2">
          <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
            <svg
              viewBox="0 0 24 24"
              className="h-12 w-12 fill-current text-primary"
            >
            ...
            <div className="space-y-2">
              <h3 className="font-bold text-primary">Next.js 14</h3>
        ...
        <div className="relative overflow-hidden rounded-lg border bg-background p-2">
          <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
            ...
            <div className="space-y-2">
              <h3 className="font-bold text-primary">Database</h3>
              <p className="text-sm text-muted-foreground">
        ...
        <div className="relative overflow-hidden rounded-lg border bg-background p-2">
          <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
            ...
            <div className="space-y-2">
              <h3 className="font-bold text-primary">Components</h3>
              <p className="text-sm text-muted-foreground">
        ...
        <div className="relative overflow-hidden rounded-lg border bg-background p-2">
          <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
            ...
            <div className="space-y-2">
              <h3 className="font-bold text-primary">Subscriptions</h3>
              <p className="text-sm text-muted-foreground ">
